...
\personalinfo{%
  ...
  \location{6 Avenue de Belle Fontaine, B.108 - 35510 Cesson Sévigné} \\
  %% \location{Location, COUNTRY}
  \homepage{Age: 21 ans (06/04/1998)} \\
...
\cvsection[page1sidebar]{Parcours}
\cvevent{École d'ingénieur}{Centrale Sup\'elec}{2018  -- 2021}{Paris, France}
\divider
\cvevent{\ CPGE}{Lyc\'ee Saint-Louis}{2016 -- 2018}{Paris, France}
\begin{itemize}
...
\cvevent{Construction d'un site web}{Projet pour l'association CS Design}{2019}{}
\divider
\cvevent{\ Cybersécurité SIEM}{Pôle cybersécurité Centrale Supélec Rennes}{2018}{}
\begin{itemize}
...
\begin{itemize}
	\item Sport\\%: \medskip \quad Tous en général et le basket en particulier
\divider
	\item Informatique \\
\divider
	\item Voyager \\
